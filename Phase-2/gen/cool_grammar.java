// Generated from /home/ziad/Desktop/Study/8th Semester/Compilers/PA2_120200078/cool_grammar.g4 by ANTLR 4.13.1
...
public class cool_grammar extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T", "U", "V", "W", "CLASS", "ELSE", "FI", "IF", "IN", "INHERITS", "ISVOID", 
			"LET", "LOOP", "POOL", "THEN", "WHILE", "CASE", "ESAC", "NEW", "OF", 
			"NOT", "TRUE", "FALSE", "INTEGERS", "SELF", "SELF_TYPE", "TYPE_IDENTIFIER", 
	...
	public void action(RuleContext _localctx, int ruleIndex, int actionIndex) {
		...
		case 38:
			...
			break;
		case 39:
			SELF_TYPE_action((RuleContext)_localctx, actionIndex);
			break;
		}
	}
	private void SELF_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 0:
			setType(OBJECT_IDENTIFIER);
			break;
		}
	}
	private void SELF_TYPE_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 1:
